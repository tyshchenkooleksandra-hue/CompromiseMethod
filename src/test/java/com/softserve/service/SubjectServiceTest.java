...
class SubjectServiceTest {
    ...
    class GetMethodsTests {
        ...
        void getSubjectsWithTypes() {
            ...
            SubjectWithTypeDTO firstSubjectWithType =
                    new SubjectWithTypeDTO(firstSubject, LessonType.LECTURE);

            SubjectWithTypeDTO secondSubjectWithType =
                    new SubjectWithTypeDTO(secondSubject, LessonType.PRACTICAL);

            List<SubjectWithTypeDTO> subjectsWithTypes =
                    List.of(firstSubjectWithType, secondSubjectWithType);

            SubjectNameWithTypesDTO firstResult =
                    new SubjectNameWithTypesDTO();

            firstResult.setId(1L);
            firstResult.setName("Organic chemistry");

            SubjectNameWithTypesDTO secondResult =
                    new SubjectNameWithTypesDTO();

            secondResult.setId(2L);
            secondResult.setName("Economics");

            List<SubjectNameWithTypesDTO> expectedResult =
                    List.of(firstResult, secondResult);

            when(subjectRepository.getSubjectsWithTypes(1L, 3L))
                    .thenReturn(subjectsWithTypes);

            when(subjectMapper
                    .subjectWithTypeDTOsToSubjectNameWithTypesDTOs(subjectsWithTypes))
                    .thenReturn(expectedResult);

            List<SubjectNameWithTypesDTO> actualResult =
                    subjectService.getSubjectsWithTypes(1L, 3L);

            assertNotNull(actualResult);
            assertEquals(expectedResult.size(), actualResult.size());

            verify(subjectRepository, times(1))
                    .getSubjectsWithTypes(1L, 3L);
        ...
        @Test
        void getSubjectsWithTypesEmptyList() {
            when(subjectRepository.getSubjectsWithTypes(1L, 3L))
                    .thenReturn(List.of());

            when(subjectMapper
                    .subjectWithTypeDTOsToSubjectNameWithTypesDTOs(List.of()))
                    .thenReturn(List.of());

            List<SubjectNameWithTypesDTO> result =
                    subjectService.getSubjectsWithTypes(1L, 3L);
        ...
        void getAllSubjects() {
            ...
            when(subjectMapper.subjectsToSubjectDTOs(subjects))
            ...
            verify(subjectMapper, times(1))
                    .subjectsToSubjectDTOs(subjects);
        }

        @Test
        void getAllSubjectsWithEmptyResult() {
            when(subjectRepository.getAll()).thenReturn(List.of());

            when(subjectMapper.subjectsToSubjectDTOs(List.of()))
                    .thenReturn(List.of());
        ...
        @Test
        void getDisabledSubjectsWithEmptyResult() {
            when(subjectRepository.getDisabled()).thenReturn(List.of());
    ...
    class SaveTests {
        ...
        void saveSubjectIfNameDoesNotExists() {
            ...
            when(subjectRepository.countSubjectsWithName(anyString()))
                    .thenReturn(0L);

            when(subjectMapper.subjectDTOToSubject(inputDTO))
                    .thenReturn(subject);

            when(subjectRepository.save(subject))
                    .thenReturn(subject);

            when(subjectMapper.subjectToSubjectDTO(subject))
            ...
            verify(subjectRepository, times(1))
                    .countSubjectsWithName(anyString());

            verify(subjectMapper, times(1))
                    .subjectDTOToSubject(inputDTO);
    ...
    class UpdateTests {
        ...
        void updateSubjectIfNameDoesNotExists() {
            ...
            when(subjectRepository
                    .countSubjectsWithNameAndIgnoreWithId(1L, "updated name"))
                    .thenReturn(0L);

            when(subjectMapper.subjectDTOToSubject(inputDTO))
                    .thenReturn(updatedSubject);

            when(subjectRepository.update(updatedSubject))
                    .thenReturn(updatedSubject);

            when(subjectMapper.subjectToSubjectDTO(updatedSubject))
            ...
            verify(subjectMapper, times(1))
                    .subjectToSubjectDTO(updatedSubject);
        }
        ...
        void throwFieldAlreadyExistsExceptionIfUpdatedNameAlreadyExists() {
            ...
            when(subjectRepository.countBySubjectId(1L))
                    .thenReturn(1L);
            ...
            assertThrows(FieldAlreadyExistsException.class,
                    () -> subjectService.update(inputDTO));
    ...
    class DeleteTests {
        ...
        void deleteById() {
            ...
            when(subjectRepository.delete(subject))
                    .thenReturn(subject);
